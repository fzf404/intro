...
LastEditTime: 2023-05-07 22:09:57
Description: 自我介绍后端
"""
...
def intro():
    ...
    return {"code": 404, "data": {}, "msg": "没有找到该用户,第一次使用别忘了新建用户!"}
...
def new():
    ...
    if (id and name and sex and intro and about and password) is None:
        return {"code": 400, "data": {}, "msg": "所有字段不应为空，请输入所有字段哦!"}
    ...
    for item in data_raw:
        id_tmp = item[0]
        if id == id_tmp:
            return {"code": 403, "data": {}, "msg": "该用户已存在，如需修改，请使用修改功能!"}
    ...
    # 不允许则返回
    if not allow:
        return {"code": 403, "data": {}, "msg": "该用户不在列表中，请联系管理员!"}
    ...
    return {"code": 200, "data": {"id": id, "name": name}, "msg": "Ok"}
    ...
    for index, item in enumerate(data):
        ...
        if id == id_tmp:
            if password == password_tmp:
                ...
                # 密码错误
                return {"code": 403, "data": {}, "msg": "密码不正确，忘记密码请联系管理员哦"}

    # 未修改则用户不存在
    return {"code": 404, "data": {}, "msg": "该用户并不存在，请检查信息是否填写正确"}
